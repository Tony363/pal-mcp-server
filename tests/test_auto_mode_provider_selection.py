...
class TestAutoModeProviderSelection:
    ...
    def test_openai_only_fallback_selection(self):
        ...
        try:
            ...
            assert extended_reasoning == "gpt-5.4"  # GPT-5.4 prioritized for extended reasoning
    ...
    def test_both_gemini_and_openai_priority(self):
        ...
        try:
            ...
            assert extended_reasoning == "gemini-3.1-pro"  # Gemini 3.1 Pro has higher priority now
